	...
	function peg$parse( input ) {
		var options = arguments.length > 1 ? arguments[ 1 ] : {},
			...
			peg$startRuleFunctions = {
				CompilationUnit: peg$parseCompilationUnit
			},
			peg$startRuleFunction = peg$parseCompilationUnit,

			peg$c0 = function( packageN, imports, types ) {
				return {
			...
			peg$c2 = function( staticN, name, asterisk ) {
				return {
			...
			peg$c79 = function( first, tail ) {
				return [ first ].concat( tail.map( function( arr ) {
					return arr[ 1 ]
				} ) );
			},
			peg$c80 = function( expr, then, alt ) {
				return {
			...
			peg$c85 = function( arg, sel, sels, operator ) {
			...
			peg$c86 = function( arg, sel, sels ) {
				return buildSelectorTree( arg, sel, sels );
			},
			peg$c87 = function( arg, operator ) {
				return operator.length > 1 ? TODO( /* JLS7? */) : {
					node: 'PostfixExpression',
					operator: operator[ 0 ],
					operand: arg
			...
			peg$c91 = function( suffix ) {
				return suffix.node === 'SuperConstructorInvocation' ? suffix : mergeProps( suffix, {
					qualifier: null
				} );
			},
			peg$c92 = function( creator ) {
				return creator;
			},
			peg$c93 = function( type, dims ) {
				return {
					node: 'TypeLiteral',
			...
			peg$c95 = function( qual, dims ) {
				return {
					node: 'TypeLiteral',
					type: buildArrayTree( buildTypeName( qual, null, [] ), dims )
				};
			},
			peg$c96 = function( qual, expr ) {
				return {
					node: 'ArrayAccess',
					array: qual,
					index: expr
			...
			peg$c98 = function( qual ) {
				return {
					node: 'TypeLiteral',
					type: buildTypeName( qual, null, [] )
				};
			},
			peg$c99 = function( qual, ret ) {
				if ( ret.expression ) return TODO( /* Ugly ! */);
				ret.expression = qual;
				return ret;
			},
			peg$c100 = function( qual ) {
				return {
					node: 'ThisExpression',
					qualifier: qual
				};
			},
			peg$c101 = function( qual, args ) {
				return {
			...
			peg$c102 = function( qual, args, rest ) {
				return mergeProps( rest, {
					expression: qual,
			...
			peg$c108 = function( ret ) {
				return ret;
			},
			peg$c109 = function() {
				return TODO( /* Any sample ? */);
			},
			peg$c110 = function( args, ret ) {
				return mergeProps( ret, {
					typeArguments: optionalList( args )
				} );
			},
			...
			peg$c130 = function( type ) {
				return makePrimitive( type );
			},
			peg$c131 = function( args ) {
				return optionalList( args );
			},
			peg$c132 = function( type, rest ) {
				return {
					node: 'ArrayCreation',
			...
			peg$c133 = function( args, type, rest ) {
				return mergeProps( rest, {
			...
			peg$c134 = function( qual, args, rest ) {
				return buildTypeName( qual, args, rest );
			},
			peg$c135 = function( id, args, rest ) {
				return mergeProps( rest, {
					node: 'ClassInstanceCreation',
			...
			peg$c138 = function( dimexpr, dims ) {
				return {
			...
			peg$c144 = function( type, dims ) {
				return buildArrayTree( type, dims );
			},
			peg$c145 = function( bas, dims ) {
				return buildArrayTree( bas, dims );
			},
			peg$c146 = function( cls, dims ) {
			...
			peg$c173 = function( keyword ) {
				return makeModifier( keyword );
			},
			peg$c174 = function( id, body ) {
				return {
			...
			peg$c175 = function( decl ) {
				return skipNulls( decl );
			},
			peg$c176 = function( modifiers, rest ) {
				return mergeProps( rest, {
					modifiers: modifiers
				} );
			},
			peg$c177 = function( type, rest ) {
				return mergeProps( rest, {
					type: type
				} );
			},
			peg$c178 = function( id, def ) {
				return {
